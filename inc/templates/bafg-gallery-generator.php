...
<!--Gallery generator-->
	...
	<div id="bafg_filter_gallery_generator">
		...
		<p><?php echo esc_html__('With this option, you can easily generate 2 columns, 3 columns or even 4 columns Before - After Filterable Gallery. Just select the options below, generate shortcode and copy-paste the shortcode wherever you want to show the gallery on your website. That\'s it'); ?> <a target="_blank" href="https://live.themefic.com/beaf/pro/#filtergallery"><?php echo esc_html__( 'Click here', 'bafg' ); ?></a> <?php echo esc_html__( 'to learn more.', 'bafg' ); ?></p>
		...
		<div class="bafg-upgrade-to-pro"><a target="_blank" href="https://live.themefic.com/beaf/pro">Upgrade to pro!</a></div>
